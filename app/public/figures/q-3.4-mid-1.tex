...
\begin{tikzpicture}[scale=0.8]
  ...
  % Points
  \fill[red!70!black]  (F1) circle (2.5pt) node[below left]  {$F_1(-1,0)$};
  \fill[red!70!black]  (F2) circle (2.5pt) node[below right] {$F_2(1,0)$};
  ...
  \node[text=gray, font=\small, align=center] at (0, -2.8)
    {$\dfrac{x^2}{4}+\dfrac{y^2}{3}=1\qquad |AB|=\dfrac{24}{7}\quad S_{\triangle F_1AB}=\dfrac{12\sqrt2}{7}$};
\end{tikzpicture}
\end{document}
