...
\begin{tikzpicture}[scale=1.0]
  ...
  % Points
  \fill[red!70!black]  (F1) circle (2.5pt) node[below] {$F_1(-\sqrt3,0)$};
  \fill[red!70!black]  (F2) circle (2.5pt) node[below] {$F_2(\sqrt3,0)$};
  \fill[blue!70!black] (P)  circle (2.5pt) node[above] {$P(0,1)$};
  \fill[black]         (O)  circle (1.5pt) node[below left] {$O$};

  % Labels
  \node[blue!50!black] at (-1.0, 0.6) {$r_1=2$};
  \node[blue!50!black] at (1.0, 0.6)  {$r_2=2$};
  \node[gray] at (0, -0.3) {$2c=2\sqrt3$};

  \node[text=gray, font=\small, align=center] at (0, -2.2)
    {$e=\dfrac{\sqrt3}{2}\quad\dfrac{x^2}{4}+y^2=1\quad S_{\triangle}=\sqrt3\quad r_1=r_2=2$};
\end{tikzpicture}
\end{document}
