...
\begin{tikzpicture}[scale=0.85]
  ...
  % Points
  \fill[blue!70!black] (A) circle (2.5pt) node[above right] {$A(0,1)$};
  \fill[blue!70!black] (B) circle (2.5pt) node[below left]  {$B(-\frac{8}{5},-\frac{3}{5})$};
  ...
  \node[text=gray, font=\small, align=center] at (0, -2.2)
    {$\dfrac{x^2}{4}+y^2=1\qquad |AB|=\sqrt{1+k^2}\,|x_1-x_2|=\sqrt2\cdot\frac{8}{5}=\frac{8\sqrt2}{5}$};
\end{tikzpicture}
\end{document}
